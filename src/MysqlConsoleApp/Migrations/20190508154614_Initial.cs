        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    owner_id = table.Column<string>(maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    user_id = table.Column<string>(maxLength: 32, nullable: false),
                    group_id = table.Column<string>(maxLength: 32, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bpm_identity_link_bpm_package_package_id",
                        column: x => x.package_id,
                        principalTable: "bpm_package",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    activity_type = table.Column<string>(maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    event_name = table.Column<string>(maxLength: 64, nullable: false),
                    activity_id = table.Column<string>(maxLength: 64, nullable: true),
                    proc_def_id = table.Column<int>(nullable: true),
                    proc_inst_id = table.Column<long>(nullable: true),
                    token_id = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    act_inst_id = table.Column<long>(nullable: true),
                    state = table.Column<int>(nullable: false),
                    delegation_state = table.Column<int>(nullable: true),
                    last_state_time = table.Column<DateTime>(nullable: false),
                    token_id = table.Column<long>(nullable: true),
                    name = table.Column<string>(maxLength: 100, nullable: false),
                    ...
                    owner = table.Column<string>(maxLength: 32, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bpm_task_bpm_proc_def_proc_def_id",
                        column: x => x.proc_def_id,
                        principalTable: "bpm_proc_def",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bpm_comment_bpm_user_user_id",
                        column: x => x.user_id,
                        principalTable: "bpm_user",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    stack_trace = table.Column<string>(maxLength: 512, nullable: true),
                    token_id = table.Column<long>(nullable: true),
                    task_id = table.Column<long>(nullable: true),
                    created = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bpm_scheduled_job_bpm_task_task_id",
                        column: x => x.task_id,
                        principalTable: "bpm_task",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bpm_identity_link_package_id",
                table: "bpm_identity_link",
                column: "package_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bpm_proc_inst_token_id",
                table: "bpm_proc_inst",
                column: "token_id");

            migrationBuilder.CreateIndex(
                name: "IX_bpm_scheduled_job_key",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bpm_scheduled_job_task_id",
                table: "bpm_scheduled_job",
                column: "task_id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_bpm_proc_inst_bpm_token_token_id",
                table: "bpm_proc_inst",
                column: "token_id",
                principalTable: "bpm_token",
                principalColumn: "id",
