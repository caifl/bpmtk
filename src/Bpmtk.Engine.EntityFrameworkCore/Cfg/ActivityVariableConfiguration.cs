...
{
    public class ActivityVariableConfiguration : IEntityTypeConfiguration<ActivityVariable>
    {
        public virtual void Configure(EntityTypeBuilder<ActivityVariable> builder)
        {
